...
Route::prefix('cms/admin/')->middleware('auth:admin,author')->group(function(){
    ...
    // Route::post('/update-admin-status', 'AdminController@changeStatus')->name('admins.status');
    // Route::post('admins.status' , [AdminController::class , 'changeStatus'])->name('admins.status');
