      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
           {{-- <a href="#" class="d-block"> {{ auth('admin')->user()->full_name }}</a> --}}
            ...
            <img class="brand-image img-circle elevation-3 " width="60" height="60" src="{{ asset('storage/images/admin/' . auth('admin')->user()->images) }}"alt="User Image">
            @else
            ...
            <img src="{{ asset('storage/images/author/'.auth('author')->user()->images) }}" class="brand-image img-circle elevation-3" alt="User Image">
            @else
            <img class="brand-image img-circle elevation-3" src="{{ asset('images/userSolid.png') }}"alt="User Image">
            @endif
